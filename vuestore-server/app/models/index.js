...
db.products = require("./product.model.js")(mongoose); // import product model serta mongoose dan masukkan ke object db / register model product
db.orders = require("./order.model.js")(mongoose) // register model order
